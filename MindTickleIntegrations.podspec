#
#  Be sure to run `pod spec lint MindTickleIntegrations.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "hridayesh gupta" => "hridayesh.gupta@mindtickle.com" }
  # Or just: s.author    = "hridayesh gupta"
  # s.authors            = { "hridayesh gupta" => "hridayesh.gupta@mindtickle.com" }
  # s.social_media_url   = "http://twitter.com/hridayesh gupta"
  ...
  s.source_files  = "MindTickleIntegrations/**/*.{m,h}"
